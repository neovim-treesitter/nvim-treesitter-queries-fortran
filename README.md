# nvim-treesitter-queries-fortran

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-fortran/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-fortran/actions/workflows/validate.yml)

Neovim tree-sitter queries for **fortran**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-fortran",
...
- [ ] Changes are scoped to `fortran` — do not include files for other languages
